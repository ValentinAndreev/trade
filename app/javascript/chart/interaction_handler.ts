...
export default class InteractionHandler {
  ...
  _ensureChartSubscriptions(): void {
  ...
  _cleanupCrosshairIfNeeded(): void {
  ...
  _showLabelTooltip(x: number, y: number, text: string): void {
