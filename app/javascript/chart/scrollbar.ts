...
export interface ScrollbarOptions {
  ...
  getTotalBars: () => number
  getTimeRange?: () => { first: number; last: number }
  onGoStart?: () => void
  onGoEnd?: () => void
...
export default class Scrollbar {
  ...
  btnEnd: HTMLButtonElement
  el: HTMLDivElement
  thumb: HTMLDivElement
  _onThumbDown?: (e: MouseEvent) => void
  _onMouseMove?: (e: MouseEvent) => void
  _onMouseUp?: () => void
  _onTrackClick?: (e: MouseEvent) => void
  _startX?: number
  _startFrom?: number
  _startTo?: number

  constructor(container: HTMLElement, { getVisibleRange, setVisibleRange, getTotalBars, getTimeRange, onGoStart, onGoEnd, onGoToDate }: ScrollbarOptions) {
