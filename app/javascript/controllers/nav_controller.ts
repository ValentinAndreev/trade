...
export default class extends Controller {
  ...
  declare mainPageTarget: HTMLElement
  declare graphPageTarget: HTMLElement
  declare mainBtnTarget: HTMLElement
  ...
  _setActive(active: HTMLElement, inactive: HTMLElement): void {
