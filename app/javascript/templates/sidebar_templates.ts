...
export function modeBtnHTML(ctrl: string, mode: string, label: string, isActive: boolean): string {
  return `<button
...
export function toggleBtnHTML(ctrl: string, action: string, label: string, isActive: boolean): string {
...
export function opacitySliderHTML(
  percent: number,
  action: string,
  label: string,
  dataAttr: string
...
export function chartTypeOptsHTML(
...
export function colorSchemeDropdownHTML(ctrl: string, selected: number): string {
...
function colorSwatchHTML(color: string, label: string, textClass = ""): string {
...
export function overlayItemHTML(
  ctrl: string,
  o: Overlay,
  isSelected: boolean,
  panel: Panel,
