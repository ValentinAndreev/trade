...
export function panelLegendHTML(panel) {
...
export function controlButtonsHTML(ctrl, panelId, isFirst, isLast) {
...
export function emptyPanelHTML(ctrl, panelId, borderClass, buttonsHTML) {
  return `
...
export function chartPanelHTML(ctrl, panelId, borderClass, buttonsHTML, overlaysJson, timeframe, structuralKey, legendHTML) {
  return `
    <div data-panel-id="${panelId}"
         data-action="click->${ctrl}#selectPanel"
...
export function tabButtonHTML(ctrl, tabId, label, isActive, canRemove) {
  return `
    <button
      data-tab-id="${tabId}"
...
export function addTabButtonHTML(ctrl) {
  return `
    <button
