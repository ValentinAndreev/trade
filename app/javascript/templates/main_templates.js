...
export function tickerTileHTML(t) {
  ...
  const sparkline = t.sparkline?.length > 1 ? sparklineSVG(t.sparkline, t.change_24h >= 0) : ""
...
export function marketTileHTML(q, category) {
  if (!q) return ""
...
export function sparklineSVG(points, isPositive) {
