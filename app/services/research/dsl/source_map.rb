...
module Research
  module Dsl
    # Maps YAML AST paths to line/column locations for editor diagnostics.
    # Built lazily from the already-parsed Psych document so valid documents
    # (the common case) pay no construction cost.
    class SourceMap
