...
RSpec.describe Research::Dsl::ConditionExpression do
  describe Research::Dsl::ConditionExpression::Parser do
  ...
  describe Research::Dsl::ConditionExpression::Evaluator do
    ...
    def evaluate(expression, row:, prev_row: nil, params: {})
      ast = Research::Dsl::ConditionExpression::Parser.new(expression).parse
