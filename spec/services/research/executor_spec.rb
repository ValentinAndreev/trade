...
RSpec.describe Research::Executor do
  ...
  describe '#run' do
    it 'executes ema cross through the EMA server module and returns trades' do
    ...
    it 'executes rsi threshold through the RSI server module and returns trades' do
      result = described_class.new(
        system: rsi_system,
        symbol: 'BTCUSD',
        timeframe: '1m',
