class CreateSolidQueueTables < ActiveRecord::Migration[8.1]
  def change
    ...
    create_table :solid_queue_ready_executions do |t|
      t.references :job, null: false, index: { unique: true, name: "index_solid_queue_ready_executions_on_job_id" }
      t.string :queue_name, null: false
      t.integer :priority, default: 0, null: false
      t.datetime :created_at, null: false
    end
    ...
    create_table :solid_queue_claimed_executions do |t|
      t.references :job, null: false, index: { unique: true, name: "index_solid_queue_claimed_executions_on_job_id" }
      t.bigint :process_id
      t.datetime :created_at, null: false
    end
    ...
    create_table :solid_queue_blocked_executions do |t|
      t.references :job, null: false, index: { unique: true, name: "index_solid_queue_blocked_executions_on_job_id" }
      t.string :queue_name, null: false
      t.integer :priority, default: 0, null: false
    ...
    create_table :solid_queue_failed_executions do |t|
      t.references :job, null: false, index: { unique: true, name: "index_solid_queue_failed_executions_on_job_id" }
      t.text :error
      t.datetime :created_at, null: false
    end
    ...
    create_table :solid_queue_recurring_executions do |t|
      t.references :job, null: false, index: { unique: true, name: "index_solid_queue_recurring_executions_on_job_id" }
